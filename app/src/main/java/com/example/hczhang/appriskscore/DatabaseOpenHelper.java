...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    /*
	 * DatabaseOpenHelper:
     * Create or open a database for the application
	 */
    ...
    /*
	 * CreateMinimalDb:
     * Creations minimum tables the database
	 */
    ...
    /*
	 * FillCategory:
     * Added a link to its category and permissions
     * In the database
	 */
...
     * In the database
    ...
    private void fillDb(SQLiteDatabase db) {
        ...
        for (int i = 0; i < count; ++i) {
            // adds each of them to the database
            values = new ContentValues();
...
     * Called when creating a database
    ...
    /*
	 * onUpgrade
     * Called when changing version of the database
	 */
    @Override
